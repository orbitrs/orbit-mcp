...
pub async fn find_component_files<P: AsRef<Path>>(dir: P, extension: &str) -> Result<Vec<PathBuf>> {
...
pub async fn write_component_file<P: AsRef<Path>>(path: P, content: &str) -> Result<()> {
